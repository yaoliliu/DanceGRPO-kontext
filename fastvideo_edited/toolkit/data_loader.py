...
class AiToolkitDataset(LatentCachingMixin, ControlCachingMixin, CLIPCachingMixin, BucketsMixin, CaptionMixin, Dataset):
    ...
    def __init__(
        ...
        self.dataset_config.bucket_tolerance = 16
...
def get_dataloader_from_datasets(
    ...
    sampler = DistributedSampler(
                concatenated_dataset, rank=rank, num_replicas=world_size, shuffle=True, seed=seed
    )
    ...
    return data_loader, sampler, num_samples
