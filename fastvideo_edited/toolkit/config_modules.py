...
class DatasetConfig:
    ...
    def __init__(self, **kwargs):
        ...
        self.referenced_path: Union[str,List[str]] = kwargs.get('referenced_path', None)  # depth maps, etc
        if self.referenced_path == '':
        ...
        self.full_size_referenced_images: bool = kwargs.get('full_size_referenced_images', False)
